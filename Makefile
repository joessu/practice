...
# Template: app
# Command: /home/runtime/Qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile practice.pro
#############################################################################
...
QMAKE         = /home/runtime/Qt/5.5/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = practice1.0.0
DISTDIR = /home/runtime/Desktop/practice/.tmp/practice1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/runtime/Qt/5.5/gcc_64 -Wl,-rpath,/home/runtime/Qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/runtime/Qt/5.5/gcc_64/lib -lQt5Quick -L/usr/lib64 -lQt5Gui -lQt5Qml -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: practice.pro ../../Qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.5/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.5/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
		...
		practice.pro \
		qml.qrc \
		/home/runtime/Qt/5.5/gcc_64/lib/libQt5Quick.prl \
		/home/runtime/Qt/5.5/gcc_64/lib/libQt5Gui.prl \
		/home/runtime/Qt/5.5/gcc_64/lib/libQt5Qml.prl \
		/home/runtime/Qt/5.5/gcc_64/lib/libQt5Network.prl \
		/home/runtime/Qt/5.5/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile practice.pro
...
qrc_qml.cpp: qml.qrc \
		...
		car.js \
		main.qml
	/home/runtime/Qt/5.5/gcc_64/bin/rcc -name qml qml.qrc -o qrc_qml.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/practice/bin || mkdir -p $(INSTALL_ROOT)/opt/practice/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/practice/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/practice/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/practice/bin/ 
